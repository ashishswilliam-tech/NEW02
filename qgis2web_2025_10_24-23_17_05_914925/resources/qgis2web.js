...
map.getView().fit([8579014.483950, 939143.113911, 8592637.853258, 945574.399199], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PERUMKADAVILA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (102 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is a tendative work of Professor Asish S William. Thanks for his efforts and sufferings. 1 minute';
            }
